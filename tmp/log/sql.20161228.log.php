...
20161228 10:38:08: task-create-3--0
  ...
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('新闻中心的设计和开发。122') AND  openedDate  >= '2016-12-28 10:37:08' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '2',`type` = 'review',`story` = '2',`color` = '',`name` = '新闻中心的设计和开发。122',`pri` = '2',`estimate` = '2',`desc` = '2',`estStarted` = '2016-12-28',`deadline` = '2016-12-28',`mailto` = ',tester2',`project` = '3',`left` = '2',`status` = 'wait',`storyVersion` = '2',`openedBy` = 'admin',`openedDate` = '2016-12-28 10:38:08',`assignedTo` = 'dev1',`assignedDate` = '2016-12-28 10:38:08',`source` = 'QA'
...
20161228 10:40:22: task-finish-390
  ...
  INSERT INTO `zt_review` SET `fileNO` = '1',`recorder` = '1',`reviewName` = '1',`task` = '390',`doc` = '1',`referenceDoc` = '1',`reference` = '1',`pages` = '1',`reviewers` = '1',`reviewDate` = '2016-12-28',`reviewScope` = '1',`reviewPlace` = '1',`effort` = '1',`conclusion` = '通过'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '390'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '390',`actor` = 'admin',`action` = 'finished',`date` = '2016-12-28 10:40:22',`comment` = '上传了附件 2\n2',`extra` = '',`product` = ',1,',`project` = '3'
  ...
  INSERT INTO `zt_history` SET `field` = 'conclusion',`old` = '',`new` = '通过',`diff` = '',`action` = '1266'
...
20161228 10:40:51: task-edit-390
  ...
  UPDATE `zt_review` SET `fileNO` = '1',`recorder` = '1',`reviewName` = '1',`task` = '390',`doc` = '1',`referenceDoc` = '1',`reference` = '1',`pages` = '1',`reviewers` = '1',`reviewDate` = '2016-12-28',`reviewScope` = '1',`reviewPlace` = '1',`effort` = '1',`conclusion` = '通过',`id` = '55' WHERE id  = '55' LIMIT 1 
...
20161228 10:41:50: task-create-3--0
  ...
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('首页设计和开发4') AND  openedDate  >= '2016-12-28 10:40:50' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '1',`type` = 'devel',`story` = '1',`color` = '',`name` = '首页设计和开发4',`pri` = '3',`estimate` = '4',`desc` = '4',`estStarted` = '2016-12-28',`deadline` = '2016-12-28',`mailto` = ',tester2',`project` = '3',`left` = '4',`status` = 'wait',`storyVersion` = '3',`openedBy` = 'admin',`openedDate` = '2016-12-28 10:41:50',`assignedTo` = 'dev1',`assignedDate` = '2016-12-28 10:41:50'
