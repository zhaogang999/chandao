...
20161212 15:00:12: user-login-Lw==
=======
20161212 09:31:11: 
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
...
<<<<<<< HEAD
20161212 15:00:22: user-login-Lw==
=======
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
<<<<<<< HEAD
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '127.0.0.1', `last` = '1481526022' WHERE account  = 'admin'
=======
...
<<<<<<< HEAD
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 15:00:22',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 15:00:22: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:00:22: my
=======
...
<<<<<<< HEAD
20161212 15:00:24: block-printBlock-1-my
=======
...
<<<<<<< HEAD
20161212 15:00:24: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:00:24: block-printBlock-2-my
=======
...
20161212 15:00:24: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:00:25: block-printBlock-5-my
=======
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
...
<<<<<<< HEAD
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:00:25' GROUP BY product
=======
...
<<<<<<< HEAD
20161212 15:00:25: block-printBlock-6-my
=======
...
<<<<<<< HEAD
20161212 15:00:25: block-printBlock-7-my
=======
...
<<<<<<< HEAD
20161212 15:00:25: block-printBlock-8-my
=======
...
<<<<<<< HEAD
20161212 15:00:25: block-printBlock-9-my
=======
...
<<<<<<< HEAD
20161212 15:00:30: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:00:32: company
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:00:33: company-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:00:34: report
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:00:34: report-productSummary
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT id, code, name, PO FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed'
  SELECT * FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('1','2','3') AND  end  > '2016-12-12'
...
20161212 15:00:36: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 15:00:36: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
<<<<<<< HEAD
20161212 15:00:38: project-task
=======
...
20161212 15:00:44: task-create-3--0
=======
  SELECT t1.product, t2.name FROM `zt_projectproduct` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.project  = '3'
...
20161212 15:00:46: story-ajaxGetProjectStories-3-0-0-1
=======
  SELECT * FROM `zt_branch` WHERE product IN ('1') AND  deleted  = '0'
  SELECT * FROM `zt_product` WHERE id IN ('1')
  SELECT openedVersion FROM `zt_project` WHERE id  = '3'
...
20161212 15:01:09: task-create-3--0
=======
...
<<<<<<< HEAD
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('首页设计和开发dssssssssssss') AND  openedDate  >= '2016-12-12 15:00:08' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '1',`type` = 'review',`story` = '1',`color` = '',`name` = '首页设计和开发dssssssssssss',`pri` = '3',`estimate` = '4',`desc` = 'sadfdsaf asfd',`estStarted` = '2016-12-12',`deadline` = '2016-12-12',`mailto` = '',`project` = '3',`left` = '4',`status` = 'wait',`storyVersion` = '2',`openedBy` = 'admin',`openedDate` = '2016-12-12 15:01:08',`assignedTo` = 'productManager',`assignedDate` = '2016-12-12 15:01:08'
=======
...
<<<<<<< HEAD
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'opened',`date` = '2016-12-12 15:01:08',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE `id` = '766' 
  SELECT * FROM `zt_history` WHERE action IN ('766') ORDER BY `id` 

20161212 15:01:11: task-create-3-1-0
=======
...
20161212 15:01:21: project-task-3
=======
  SELECT * FROM `zt_branch` WHERE product IN ('1') AND  deleted  = '0'
  SELECT * FROM `zt_product` WHERE id IN ('1')
  SELECT openedVersion FROM `zt_project` WHERE id  = '3'
...
20161212 15:01:27: task-start-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766') ORDER BY `id` 
=======
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '195' ORDER BY `date` desc 
  SELECT * FROM `zt_history` WHERE action IN ('754') ORDER BY `id` 
...
<<<<<<< HEAD
20161212 15:01:29: task-start-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `consumed` = '0',`left` = '4',`account` = 'admin',`task` = '196',`date` = '2016-12-12'
  UPDATE `zt_task` SET `realStarted` = '2016-12-12',`consumed` = '0',`left` = '4',`assignedTo` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:01:29',`assignedDate` = '2016-12-12 15:01:29',`status` = 'doing' WHERE id  = '196'
=======
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '195'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '195' AND  extra  != 'editor'
...
<<<<<<< HEAD
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'started',`date` = '2016-12-12 15:01:29',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'realStarted',`old` = '0000-00-00',`new` = '2016-12-12',`diff` = '',`action` = '767'
  INSERT INTO `zt_history` SET `field` = 'assignedTo',`old` = 'productManager',`new` = 'admin',`diff` = '',`action` = '767'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'wait',`new` = 'doing',`diff` = '',`action` = '767'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
=======
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE `id` = '767' 
  SELECT * FROM `zt_history` WHERE action IN ('767') ORDER BY `id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'

20161212 15:01:30: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
=======
...
20161212 15:01:31: task-view-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
  SELECT * FROM `zt_review` WHERE task  = '196'
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'story' AND  objectID  = '1' AND  extra  != 'editor'
<<<<<<< HEAD
  UPDATE `zt_action` SET  `read` = '1' WHERE objectType  = 'task' AND  objectID  = '196' AND  `read`  = '0'
=======
  UPDATE `zt_action` SET  `read` = '1' WHERE objectType  = 'task' AND  objectID  = '195' AND  `read`  = '0'
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766','767') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_task` WHERE id  = '196' OR project  = '3' AND  deleted  = '0' AND  status IN ('','wait','doing','done','pause','cancel')  ORDER BY `id` desc 
=======
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '195' ORDER BY `date` desc 
...
20161212 15:01:33: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
20161212 15:01:40: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  ...
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
  SELECT version FROM `zt_story` WHERE id  = '1'
  UPDATE `zt_task` SET `color` = '',`name` = '首页设计和开发dssssssssssss',`desc` = 'sadfdsaf asfdd3',`lastEditedDate` = '2016-12-12 15:01:39',`consumed` = '0',`project` = '3',`module` = '1',`story` = '1',`assignedTo` = 'admin',`type` = 'review',`status` = 'doing',`pri` = '3',`mailto` = '',`estStarted` = '2016-12-12',`realStarted` = '2016-12-12',`deadline` = '2016-12-12',`estimate` = '4',`left` = '4',`finishedBy` = '',`finishedDate` = '',`canceledBy` = '',`canceledDate` = '',`closedBy` = '',`closedReason` = '',`closedDate` = '',`lastEditedBy` = 'admin' WHERE id  = '196'
=======
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '195'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '195' AND  extra  != 'editor'
...
<<<<<<< HEAD
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'edited',`date` = '2016-12-12 15:01:39',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'desc',`old` = 'sadfdsaf asfd',`new` = 'sadfdsaf asfdd3',`diff` = '001- <del>sadfdsaf asfd</del>\n001+ <ins>sadfdsaf asfdd3</ins>',`action` = '768'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
=======
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE `id` = '768' 
  SELECT * FROM `zt_history` WHERE action IN ('768') ORDER BY `id` 

20161212 15:01:40: task-view-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766','767','768') ORDER BY `id` 
=======
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '195' ORDER BY `date` desc 
...
20161212 15:01:55: task-finish-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
20161212 15:02:01: task-finish-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `account` = 'admin',`task` = '196',`date` = '2016-12-12',`left` = '0',`consumed` = '3'
  UPDATE `zt_task` SET `consumed` = '3',`assignedTo` = 'admin',`finishedDate` = '2016-12-12 15:02:01',`left` = '0',`assignedDate` = '2016-12-12 15:02:01',`status` = 'done',`finishedBy` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:02:01' WHERE id  = '196'
=======
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '195'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '195' AND  extra  != 'editor'
  SELECT version FROM `zt_story` WHERE id  = '1'
...
<<<<<<< HEAD
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'finished',`date` = '2016-12-12 15:02:01',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'consumed',`old` = '0',`new` = '3',`diff` = '',`action` = '769'
  INSERT INTO `zt_history` SET `field` = 'finishedDate',`old` = '',`new` = '2016-12-12 15:02:01',`diff` = '',`action` = '769'
  INSERT INTO `zt_history` SET `field` = 'left',`old` = '4',`new` = '0',`diff` = '',`action` = '769'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'doing',`new` = 'done',`diff` = '',`action` = '769'
  INSERT INTO `zt_history` SET `field` = 'finishedBy',`old` = '',`new` = 'admin',`diff` = '',`action` = '769'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
=======
...
<<<<<<< HEAD
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '769' 
  SELECT * FROM `zt_history` WHERE action IN ('769') ORDER BY `id` 

20161212 15:02:01: task-view-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766','767','768','769') ORDER BY `id` 
=======
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '195' ORDER BY `date` desc 
...
20161212 15:02:03: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
20161212 15:03:02: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  ...
  SELECT version FROM `zt_story` WHERE id  = '1'
  SELECT * FROM `zt_review` WHERE task  = '196'
  UPDATE `zt_task` SET `module` = '1',`type` = 'review',`story` = '1',`color` = '',`name` = '首页设计和开发dssssssssssss',`pri` = '3',`estimate` = '4',`desc` = 'sadfdsaf asfdd3',`estStarted` = '2016-12-12',`deadline` = '2016-12-12',`mailto` = '',`project` = '3',`left` = '0',`status` = 'done',`assignedTo` = 'admin',`assignedDate` = '',`consumed` = '3',`realStarted` = '2016-12-12',`finishedBy` = 'admin',`finishedDate` = '2016-12-12 15:02:01',`canceledBy` = '',`canceledDate` = '',`closedBy` = '',`closedReason` = '',`closedDate` = '',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:03:02' WHERE id  = '196'
  DELETE FROM `zt_storystage` WHERE story  = '1'
  SELECT * FROM `zt_story` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '1' AND  t2.deleted  = '0'
...
20161212 15:03:12: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  UPDATE `zt_story` SET  `stage` = 'developed' WHERE id  = '1'
<<<<<<< HEAD
  INSERT INTO `zt_review` SET `fileNO` = 'sfsaf',`recorder` = 'SDaf',`reviewName` = 'sdga',`task` = '196',`doc` = 'sfer',`referenceDoc` = 'sa',`reference` = 'sdfv',`pages` = '2',`reviewers` = 'sdf',`reviewDate` = '2016-12-12',`reviewScope` = 'sfs',`reviewPlace` = 'sgr',`effort` = '22',`conclusion` = 'sdgvre'
  INSERT INTO `zt_reviewDetail` SET `reviewID` = '31',`number` = '1',`reviewer` = 'safs',`item` = 'sdf',`line` = 'dv',`severity` = 'A',`description` = 'sdfdsaf',`proposal` = 'sdvea',`changed` = 'Y',`action` = 'xzvd',`chkd` = 'Y'
  INSERT INTO `zt_reviewDetail` SET `reviewID` = '31',`number` = '2',`reviewer` = 'sdfs',`item` = 'xcvf',`line` = 'sdfds',`severity` = 'A',`description` = 'sdvd',`proposal` = 'xc vfd',`changed` = 'Y',`action` = 'xcv dz',`chkd` = 'Y'
=======
...
<<<<<<< HEAD
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'edited',`date` = '2016-12-12 15:03:12',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'fileNO',`old` = '',`new` = 'sfsaf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'recorder',`old` = '',`new` = 'SDaf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewName',`old` = '',`new` = 'sdga',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'doc',`old` = '',`new` = 'sfer',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'referenceDoc',`old` = '',`new` = 'sa',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reference',`old` = '',`new` = 'sdfv',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'pages',`old` = '',`new` = '2',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewers',`old` = '',`new` = 'sdf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewDate',`old` = '',`new` = '2016-12-12',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewScope',`old` = '',`new` = 'sfs',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewPlace',`old` = '',`new` = 'sgr',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'effort',`old` = '',`new` = '22',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'conclusion',`old` = '',`new` = 'sdgvre',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '',`new` = '1',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = '',`new` = 'safs',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = '',`new` = 'sdf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = '',`new` = 'dv',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'severity',`old` = '',`new` = 'A',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = '',`new` = 'sdfdsaf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = '',`new` = 'sdvea',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'changed',`old` = '',`new` = 'Y',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'action',`old` = '',`new` = 'xzvd',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'chkd',`old` = '',`new` = 'Y',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '',`new` = '2',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = '',`new` = 'sdfs',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = '',`new` = 'xcvf',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = '',`new` = 'sdfds',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'severity',`old` = '',`new` = 'A',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = '',`new` = 'sdvd',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = '',`new` = 'xc vfd',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'changed',`old` = '',`new` = 'Y',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'action',`old` = '',`new` = 'xcv dz',`diff` = '',`action` = '770'
  INSERT INTO `zt_history` SET `field` = 'chkd',`old` = '',`new` = 'Y',`diff` = '',`action` = '770'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE `id` = '770' 
  SELECT * FROM `zt_history` WHERE action IN ('770') ORDER BY `id` 

20161212 15:03:12: task-view-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
  SELECT * FROM `zt_review` WHERE task  = '196'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = '31'
  SELECT * FROM `zt_story` WHERE `id` = '1' 
  SELECT title,spec,verify FROM `zt_storyspec` WHERE story  = '1' AND  version  = '2'
=======
...
<<<<<<< HEAD
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766','767','768','769','770') ORDER BY `id` 
=======
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '195' ORDER BY `date` desc 
...
20161212 15:03:22: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  SELECT * FROM `zt_review` WHERE task  = '196'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = '31' AND  deleted  = '0'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT t2.id, t2.title, t2.module, t2.pri, t2.estimate, t3.name AS product FROM `zt_projectstory` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_product` AS t3  ON t1.product = t3.id  WHERE t1.project  = '3' AND  t2.deleted  = '0'
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT account, realname, deleted FROM `zt_user` WHERE account IN ('admin','','')
...
20161212 15:03:27: task-deleteReview-70
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_reviewDetail` WHERE id  = '70' AND  deleted  = '0'
  UPDATE `zt_reviewDetail` SET  `deleted` = '1' WHERE id  = '70'
  SELECT task FROM `zt_review` WHERE id  = '31'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '1' AND  storyVersion  = '2'
=======
...
<<<<<<< HEAD
  SELECT project, story FROM `zt_task` WHERE id  = '196'
  SELECT product FROM `zt_story` WHERE id  = '1'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '196',`actor` = 'admin',`action` = 'edited',`date` = '2016-12-12 15:03:27',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '2',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = 'sdfs',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = 'xcvf',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = 'sdfds',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'severity',`old` = 'A',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = 'sdvd',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = 'xc vfd',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'changed',`old` = 'Y',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'action',`old` = 'xcv dz',`new` = '',`diff` = '',`action` = '771'
  INSERT INTO `zt_history` SET `field` = 'chkd',`old` = 'Y',`new` = '',`diff` = '',`action` = '771'
  ...
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '771' 
  SELECT * FROM `zt_history` WHERE action IN ('771') ORDER BY `id` 

20161212 15:03:27: task-edit-196
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '196'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '196' AND  extra  != 'editor'
...
<<<<<<< HEAD
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '196' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('766','767','768','769','770','771') ORDER BY `id` 
=======
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
            SUM(estimate) AS totalEstimate, 
...
20161212 15:03:35: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
=======
  SELECT * FROM `zt_doc` WHERE deleted  = '0' AND  lib IN ('5') ORDER BY `id` desc 
...
20161212 15:08:24: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:08:33: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '127.0.0.1', `last` = '1481526513' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 15:08:33',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 15:08:33: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:08:33: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:08:34: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT id, account AS name FROM `zt_user` WHERE id IN ('1')
  SELECT id, name AS name FROM `zt_task` WHERE id IN ('196','195')
  SELECT id, title AS name FROM `zt_doc` WHERE id IN ('4','3','2','1')
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:08:34: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:08:34: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:08:34' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:08:34: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:08:34: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:08:34: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:08:34: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:08:34: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:08:34: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:08:35: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:08:37: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:08:38: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:08:38: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 15:08:38: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:08:38: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:08:38: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:08:38: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:08:38: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:08:38' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:08:38: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:08:38: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:09:19: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:09:55: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '172.23.114.125', `last` = '1481526595' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 15:09:55',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 15:09:55: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:09:55: my
=======
  SELECT * FROM `zt_doclib` WHERE deleted  = '0' AND  project  = '3' ORDER BY `id` 
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-1-my
=======
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:09:56: block-printBlock-2-my
=======
...
20161212 15:09:56: block-printBlock-3-my
=======
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:09:56: block-printBlock-5-my
=======
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
<<<<<<< HEAD
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:09:56' GROUP BY product
=======
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-7-my
=======
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-8-my
=======
...
<<<<<<< HEAD
20161212 15:09:56: block-printBlock-9-my
=======
...
<<<<<<< HEAD
20161212 15:09:59: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:10:08: action-trash
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  ...
  SELECT * FROM `zt_action` WHERE action  = 'deleted' AND  extra  = '1' ORDER BY `id` desc 
  SELECT id, account AS name FROM `zt_user` WHERE id IN ('13','12','11')
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:10:09: admin-sso
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:10:10: admin-safe
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:10:11: dev-api
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:10:13: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:16:26: misc-ping
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:16:41: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
...
20161212 15:19:41: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:20:14: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:21:02: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:21:26: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
...
20161212 15:22:59: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:23:14: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '172.23.25.93', `last` = '1481527394' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 15:23:14',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 15:23:14: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:23:14: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:23:15: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:23:15: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:23:16: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 15:23:16: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:23:16: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:23:16: block-printBlock-5-my
=======
...
>>>>>>> 56ce38b3ee68171c3a03a5f43eb2e61413da34c5
  ...
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
<<<<<<< HEAD
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:23:16' GROUP BY product
=======
...
<<<<<<< HEAD
20161212 15:23:16: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:23:16: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:23:16: block-printBlock-8-my
=======
...
20161212 15:23:28: project
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 

20161212 15:23:29: project-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 15:23:32: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 15:23:35: task-create-3--0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 15:23:36: task-create-3--0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 15:24:03: task-create-3--0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('dsfad') AND  openedDate  >= '2016-12-12 15:23:03' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '0',`type` = 'review',`story` = '0',`color` = '',`name` = 'dsfad ',`pri` = '3',`estimate` = '0',`desc` = '',`estStarted` = '0000-00-00',`deadline` = '0000-00-00',`mailto` = '',`project` = '3',`left` = '0',`status` = 'wait',`openedBy` = 'admin',`openedDate` = '2016-12-12 15:24:03',`assignedTo` = ''
  SELECT * FROM `zt_file` WHERE id  = ''
  SELECT project, story FROM `zt_task` WHERE id  = '197'
  SELECT product FROM `zt_projectproduct` WHERE project  = '3'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '197',`actor` = 'admin',`action` = 'opened',`date` = '2016-12-12 15:24:03',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
            SUM(estimate) AS totalEstimate, 
            SUM(consumed) AS totalConsumed, 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '776' 
  SELECT * FROM `zt_history` WHERE action IN ('776') ORDER BY `id` 

20161212 15:24:03: project-browse-3-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 

20161212 15:24:04: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 15:24:08: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_review` WHERE task  = '197'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = ''
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '197' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('776') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_task` WHERE id  = '197' OR project  = '3' AND  deleted  = '0' AND  status IN ('','wait','doing','done','pause','cancel')  ORDER BY `status`,`id` desc 

20161212 15:24:14: task-start-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
...
20161212 15:24:25: task-start-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  INSERT INTO `zt_taskestimate` SET `consumed` = '1',`left` = '1',`account` = 'admin',`task` = '197',`date` = '2016-12-12'
  UPDATE `zt_task` SET `realStarted` = '2016-12-12',`consumed` = '1',`left` = '1',`assignedTo` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:24:25',`assignedDate` = '2016-12-12 15:24:25',`status` = 'doing' WHERE id  = '197'
  SELECT project, story FROM `zt_task` WHERE id  = '197'
  SELECT product FROM `zt_projectproduct` WHERE project  = '3'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '197',`actor` = 'admin',`action` = 'started',`date` = '2016-12-12 15:24:25',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'realStarted',`old` = '0000-00-00',`new` = '2016-12-12',`diff` = '',`action` = '777'
  INSERT INTO `zt_history` SET `field` = 'consumed',`old` = '0',`new` = '1',`diff` = '',`action` = '777'
  INSERT INTO `zt_history` SET `field` = 'left',`old` = '0',`new` = '1',`diff` = '',`action` = '777'
  INSERT INTO `zt_history` SET `field` = 'assignedTo',`old` = '',`new` = 'admin',`diff` = '',`action` = '777'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'wait',`new` = 'doing',`diff` = '',`action` = '777'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '777' 
  SELECT * FROM `zt_history` WHERE action IN ('777') ORDER BY `id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'

20161212 15:24:26: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_story` WHERE `id` = '0' 
  SELECT * FROM `zt_file` WHERE objectType  = 'story' AND  objectID  = '0' AND  extra  != 'editor'
  UPDATE `zt_action` SET  `read` = '1' WHERE objectType  = 'task' AND  objectID  = '197' AND  `read`  = '0'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
            SUM(estimate) AS totalEstimate, 
            SUM(consumed) AS totalConsumed, 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '197' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('776','777') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:24:29: task-finish-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
...
20161212 15:24:36: task-finish-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  UPDATE `zt_task` SET `consumed` = '1',`assignedTo` = 'admin',`finishedDate` = '2016-12-12 15:24:36',`left` = '0',`assignedDate` = '2016-12-12 15:24:36',`status` = 'done',`finishedBy` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:24:36' WHERE id  = '197'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT project, story FROM `zt_task` WHERE id  = '197'
  SELECT product FROM `zt_projectproduct` WHERE project  = '3'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '197',`actor` = 'admin',`action` = 'finished',`date` = '2016-12-12 15:24:36',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'finishedDate',`old` = '',`new` = '2016-12-12 15:24:36',`diff` = '',`action` = '778'
  INSERT INTO `zt_history` SET `field` = 'left',`old` = '1',`new` = '0',`diff` = '',`action` = '778'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'doing',`new` = 'done',`diff` = '',`action` = '778'
  INSERT INTO `zt_history` SET `field` = 'finishedBy',`old` = '',`new` = 'admin',`diff` = '',`action` = '778'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '778' 
  SELECT * FROM `zt_history` WHERE action IN ('778') ORDER BY `id` 

20161212 15:24:37: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '197' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('776','777','778') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:24:42: task-edit-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
...
20161212 15:26:00: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 15:26:11: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
...
20161212 15:26:54: task-edit-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
...
20161212 15:27:38: task-edit-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT version FROM `zt_story` WHERE id  = '0'
  SELECT * FROM `zt_review` WHERE task  = '197'
  UPDATE `zt_task` SET `module` = '0',`type` = 'review',`story` = '0',`color` = '',`name` = 'dsfad ',`pri` = '3',`estimate` = '0',`desc` = '',`estStarted` = '0000-00-00',`deadline` = '0000-00-00',`mailto` = '',`project` = '3',`left` = '0',`status` = 'done',`assignedTo` = 'admin',`assignedDate` = '',`consumed` = '1',`realStarted` = '2016-12-12',`finishedBy` = 'admin',`finishedDate` = '2016-12-12 15:24:36',`canceledBy` = '',`canceledDate` = '',`closedBy` = '',`closedReason` = '',`closedDate` = '',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 15:27:37' WHERE id  = '197'
  INSERT INTO `zt_review` SET `fileNO` = 'dfadfads',`recorder` = 'asdfasd',`reviewName` = 'adfasdf',`task` = '197',`doc` = 'dfadfa',`referenceDoc` = 'fad',`reference` = 'adfadf',`pages` = '1',`reviewers` = 'adsfa',`reviewDate` = '2016-12-12',`reviewScope` = 'adsfa',`reviewPlace` = 'dsfa',`effort` = '1',`conclusion` = 'adsf'
  INSERT INTO `zt_reviewDetail` SET `reviewID` = '32',`number` = 'a',`reviewer` = 'sdf',`item` = 'asdf',`line` = 'asdf',`severity` = '',`description` = 'sdfa',`proposal` = 'sdfa',`changed` = '',`action` = 'sdf',`chkd` = ''
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT project, story FROM `zt_task` WHERE id  = '197'
  SELECT product FROM `zt_projectproduct` WHERE project  = '3'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '197',`actor` = 'admin',`action` = 'edited',`date` = '2016-12-12 15:27:37',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'fileNO',`old` = '',`new` = 'dfadfads',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'recorder',`old` = '',`new` = 'asdfasd',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewName',`old` = '',`new` = 'adfasdf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'doc',`old` = '',`new` = 'dfadfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'referenceDoc',`old` = '',`new` = 'fad',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reference',`old` = '',`new` = 'adfadf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'pages',`old` = '',`new` = '1',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewers',`old` = '',`new` = 'adsfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewDate',`old` = '',`new` = '2016-12-12',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewScope',`old` = '',`new` = 'adsfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewPlace',`old` = '',`new` = 'dsfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'effort',`old` = '',`new` = '1',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'conclusion',`old` = '',`new` = 'adsf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '',`new` = 'a',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = '',`new` = 'sdf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = '',`new` = 'asdf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = '',`new` = 'asdf',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = '',`new` = 'sdfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = '',`new` = 'sdfa',`diff` = '',`action` = '779'
  INSERT INTO `zt_history` SET `field` = 'action',`old` = '',`new` = 'sdf',`diff` = '',`action` = '779'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '779' 
  SELECT * FROM `zt_history` WHERE action IN ('779') ORDER BY `id` 

20161212 15:27:38: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  SELECT * FROM `zt_review` WHERE task  = '197'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = '32'
  SELECT * FROM `zt_story` WHERE `id` = '0' 
  SELECT * FROM `zt_file` WHERE objectType  = 'story' AND  objectID  = '0' AND  extra  != 'editor'
  UPDATE `zt_action` SET  `read` = '1' WHERE objectType  = 'task' AND  objectID  = '197' AND  `read`  = '0'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '197' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('776','777','778','779') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:28:10: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
<<<<<<< HEAD
20161212 15:31:27: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:37:01: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 15:40:14: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:41:27: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:49:11: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 15:49:20: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '127.0.0.1', `last` = '1481528960' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 15:49:20',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 15:49:20: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 15:49:20: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:49:21: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT id, account AS name FROM `zt_user` WHERE id IN ('1')
  SELECT id, name AS name FROM `zt_task` WHERE id IN ('197','196','195')
  SELECT id, title AS name FROM `zt_doc` WHERE id IN ('4','3','2','1')
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:49:21: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:49:21: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:49:21: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:49:21: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:49:21: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:49:21' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:49:21: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:49:21: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:49:21: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:55:22: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:55:22: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 15:55:22: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:55:22: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:55:22: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:55:22: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:55:22: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:55:22' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:55:22: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:55:22: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:55:22: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:55:24: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:55:24: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:55:24: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:55:24: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:55:24: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:55:24' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:55:24: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:55:24: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 15:55:24: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:55:24: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:55:24: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:55:27: product
=======
...
<<<<<<< HEAD
20161212 15:55:27: product-browse
=======
...
20161212 15:55:30: story-create-3-0-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 15:55:58: story-create-3-0-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 15:56:17: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 15:56:18: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 15:56:18' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 15:56:18: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 15:56:18: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 15:56:18: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 15:56:18: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 15:56:18: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 15:56:18: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 15:56:18: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 15:56:18: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 15:56:23: doc
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.* FROM `zt_doclib` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product=t2.id  WHERE t1.deleted  = '0' AND  t1.product  != '0' ORDER BY t2.`order` desc,`id` desc 
  SELECT id,name,`order` FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc,`id` desc 
...
20161212 15:56:25: doc-browse-5
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT t1.* FROM `zt_doclib` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project=t2.id  WHERE t1.project  != '0' AND  t1.deleted  = '0' ORDER BY t2.`order` desc,t1.`id` 
  ...
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT openedVersion FROM `zt_project` WHERE id  = '5doc'
  SELECT * FROM `zt_module` WHERE root  = '5' AND  type  = '0' AND  deleted  = '0' ORDER BY `grade` desc,`order` 
  SELECT * FROM `zt_product` WHERE `id` = '5' 
  SELECT * FROM `zt_module` WHERE root  = '5' AND  type  = 'doc' AND  deleted  = '0' ORDER BY `grade` desc,`order` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 15:56:27: doc-create-5-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
...
20161212 15:56:28: file-ajaxUeditorUpload-584e582ba1b91
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 16:06:28: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_config` WHERE 1 = 1  AND  owner IN ('system') AND  module IN ('common') AND  section IN ('global') AND  `key` IN ('sn')

20161212 16:16:30: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 16:16:49: user-login-Lw==
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
...
20161212 16:31:58: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 16:32:09: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '127.0.0.1', `last` = '1481531528' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 16:32:09',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 16:32:09: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 16:32:09: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 

20161212 16:32:11: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 16:32:11: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 16:32:11: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 16:32:11: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 16:32:11' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 16:32:11: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 16:32:11: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 16:32:12: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 16:32:12: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 16:32:12: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 16:32:13: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 16:32:16: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 16:32:16: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 16:32:25: doc-browse-5
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT t1.* FROM `zt_doclib` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project=t2.id  WHERE t1.project  != '0' AND  t1.deleted  = '0' ORDER BY t2.`order` desc,t1.`id` 
...
20161212 16:32:28: doc-create-5-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
...
20161212 16:32:28: file-ajaxUeditorUpload-584e609c30518
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 16:33:34: doc-create-5-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT id,title FROM `zt_doc` WHERE deleted  = '0' AND  title IN ('dfgd') AND  addedDate  >= '2016-12-12 16:32:34' AND  lib = '5' AND module = 0 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  INSERT INTO `zt_doc` SET `lib` = '5',`module` = '0',`title` = 'dfgd',`keywords` = 'dfbgfs',`type` = 'url',`acl` = 'open',`users` = '',`addedBy` = 'admin',`addedDate` = '2016-12-12 16:33:33',`version` = '1',`product` = '0',`project` = '3'
  INSERT INTO `zt_file` SET `extension` = '7z',`pathname` = '201612/1216333408021tim.7z',`title` = '别跟我谈高富帅_9266182',`size` = '104016019',`objectType` = 'doc',`objectID` = '5',`addedBy` = 'admin',`addedDate` = '2016-12-12',`extra` = ''
  INSERT INTO `zt_doccontent` SET `title` = 'dfgd',`content` = 'fsgbhdhbfgf',`type` = 'html',`version` = '1',`doc` = '5',`files` = '13'
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT product, project FROM `zt_doc` WHERE id  = '5'
  INSERT INTO `zt_action` SET `objectType` = 'doc',`objectID` = '5',`actor` = 'admin',`action` = 'created',`date` = '2016-12-12 16:33:34',`comment` = '',`extra` = '',`product` = ',0,',`project` = '3'

20161212 16:33:35: doc-browse-5-byModule-0-id_desc-doc
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_doclib` WHERE `id` = '5' 
  SELECT t1.* FROM `zt_doclib` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project=t2.id  WHERE t1.project  != '0' AND  t1.deleted  = '0' ORDER BY t2.`order` desc,t1.`id` 
...
20161212 16:36:16: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
...
20161212 16:36:18: user-login-Lw==
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 

20161212 16:43:36: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_config` WHERE 1 = 1  AND  owner IN ('system') AND  module IN ('common') AND  section IN ('global') AND  `key` IN ('sn')

20161212 16:53:36: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:03:37: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_config` WHERE 1 = 1  AND  owner IN ('system') AND  module IN ('common') AND  section IN ('global') AND  `key` IN ('sn')

20161212 17:13:37: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:18:58: qa
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:18:59: bug-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:19:00: admin
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:29:02: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_config` WHERE 1 = 1  AND  owner IN ('system') AND  module IN ('common') AND  section IN ('global') AND  `key` IN ('sn')

20161212 17:31:00: action-trash
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_action` WHERE action  = 'deleted' AND  extra  = '1' ORDER BY `id` desc 
  SELECT COUNT(*) AS recTotal FROM `zt_action` WHERE action  = 'deleted' AND  extra  = '1' 
...
20161212 17:31:02: admin-sso
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:31:03: admin-safe
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:31:05: dev-api
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:31:06: backup
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:31:08: cron
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_cron` WHERE 1=1 

20161212 17:31:12: cron-turnon
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  REPLACE `zt_config` SET `owner` = 'system',`module` = 'common',`section` = 'global',`key` = 'cron',`value` = '1'

20161212 17:31:12: cron
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_cron` WHERE 1=1 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:32:49: cron-openProcess
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:32:50: cron
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_cron` WHERE 1=1 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:32:53: custom-set
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 17:32:58: mail
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:33:00: company
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:33:01: company-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_dept` WHERE `id` = '0' 
  SELECT * FROM `zt_dept` ORDER BY `grade` desc,`order` 
...
20161212 17:33:02: report
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:33:02: report-productSummary
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT id, code, name, PO FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed'
  SELECT * FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('1','2','3') AND  end  > '2016-12-12'
...
20161212 17:33:05: qa
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:33:06: bug-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:33:08: project
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 

20161212 17:33:09: project-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:33:11: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:33:11: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:33:13: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:33:13: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 17:33:13: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 17:33:14: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  ...
  SELECT * FROM `zt_action` WHERE 1  AND  date  > '2016-12-12' AND  date  < '2016-12-13' AND  (1)  ORDER BY `date` desc 
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT id, title AS name FROM `zt_doc` WHERE id IN ('5','4','3','2','1')
  SELECT id, account AS name FROM `zt_user` WHERE id IN ('1')
  SELECT id, name AS name FROM `zt_task` WHERE id IN ('197','196','195')
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 

20161212 17:33:14: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 17:33:14: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 17:33:14' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 17:33:14: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 17:33:14: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 17:33:14: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 17:33:14: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 17:33:14: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:33:15: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:33:18: project
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 

20161212 17:33:19: project-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:33:49: cron-ajaxExec
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  ...
  UPDATE `zt_cron` SET  `lastTime` = '2016-12-12 17:32:49' WHERE lastTime  = '0000-00-00 00:00:00' AND  status  != 'stop'
  UPDATE `zt_cron` SET `status` = 'normal',`lastTime` = '2016-12-12 17:32:49' WHERE id  = '1'
...
20161212 17:34:29: misc-about
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:35:10: task-view-197
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '197'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '197' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_history` WHERE action IN ('776','777','778','779') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_task` WHERE id  = '197' OR project  = '3' AND  deleted  = '0' AND  status IN ('','wait','doing','done','pause','cancel')  ORDER BY `id` desc 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:35:14: project-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:35:55: doc-ajaxGetAllLibs
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT id,product,project,name FROM `zt_doclib` WHERE deleted  = '0' ORDER BY `product` desc,`project` desc,`id` asc 
  SELECT id,name,status FROM `zt_product` WHERE id IN ('3','2','1') AND  deleted  = '0' ORDER BY `order` desc 
  SELECT DISTINCT product FROM `zt_projectproduct` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project=t2.id  WHERE t1.product IN ('3','2','1') AND  t2.deleted  = '0'
  SELECT id,name,status FROM `zt_project` WHERE id IN ('4','3','2','1') AND  deleted  = '0' ORDER BY `order` desc 

20161212 17:44:36: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:44:36: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:44:38: product-browse-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:44:41: product-browse-3-0-allstory
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
  SELECT * FROM `zt_story` WHERE product IN ('3') AND  deleted  = '0' ORDER BY `id` desc 
  SELECT COUNT(*) AS recTotal FROM `zt_story` WHERE product IN ('3') AND  deleted  = '0' 
  SELECT * FROM `zt_story` WHERE product IN ('3') AND  deleted  = '0' ORDER BY `id` desc 
  SELECT * FROM `zt_story` WHERE product IN ('3') AND  deleted  = '0' ORDER BY `id` desc 
  SELECT id,title FROM `zt_productplan` WHERE product IN ('3') AND  deleted  = '0'
  SELECT * FROM `zt_storystage` WHERE branch IN ('0')
...
20161212 17:44:44: product-ajaxGetDropMenu-3-product-browse-
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 

20161212 17:44:47: product-browse-1
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
...
20161212 17:46:32: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:47:05: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT locked FROM `zt_user` WHERE account  = 'admin'
  SELECT * FROM `zt_user` WHERE account  = 'admin' AND  deleted  = '0'
  UPDATE `zt_user` SET  visits = visits + 1, `ip` = '10.8.4.50', `last` = '1481536024' WHERE account  = 'admin'
  UPDATE `zt_user` SET  `fails` = '0', `locked` = '0000-00-00 00:00:00' WHERE account  = 'admin'
  SELECT t1.acl FROM `zt_group` AS t1  LEFT JOIN `zt_usergroup` AS t2  ON t1.id=t2.group  WHERE t2.account  = 'admin'
  SELECT module, method FROM `zt_usergroup` AS t1  LEFT JOIN `zt_grouppriv` AS t2  ON t1.group = t2.group  WHERE t1.account  = 'admin'
  SELECT `group` FROM `zt_usergroup` WHERE `account` = 'admin' 
  INSERT INTO `zt_action` SET `objectType` = 'user',`objectID` = '1',`actor` = 'admin',`action` = 'login',`date` = '2016-12-12 17:47:05',`comment` = '',`extra` = '',`product` = ',0,',`project` = '0'

20161212 17:47:05: 
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:47:05: my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE account  = 'admin' AND  module  = 'my' AND  hidden  = '0' ORDER BY `order` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:47:06: block-printBlock-3-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '3'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  status  != 'done' AND  deleted  = '0' ORDER BY `order` desc 
...
20161212 17:47:06: block-printBlock-1-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '1'

20161212 17:47:06: block-printBlock-2-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '2'
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
...
20161212 17:47:06: block-printBlock-5-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '5'
  SELECT * FROM `zt_product` WHERE deleted  = '0' AND  status  != 'closed' ORDER BY `order` desc 
  ...
  SELECT * FROM `zt_product` WHERE id IN ('3','2','1') ORDER BY `order` desc 
  SELECT product, status, count(status) AS count FROM `zt_story` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product, status
  SELECT product, count(*) AS count FROM `zt_productplan` WHERE deleted  = '0' AND  product IN ('3','2','1') AND  end  > '2016-12-12 17:47:06' GROUP BY product
  SELECT product, count(*) AS count FROM `zt_release` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS conut FROM `zt_bug` WHERE deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE status  = 'active' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product
  SELECT product,count(*) AS count FROM `zt_bug` WHERE AssignedTo  = '' AND  deleted  = '0' AND  product IN ('3','2','1') GROUP BY product

20161212 17:47:06: block-printBlock-4-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '4'
  SELECT * FROM `zt_todo` WHERE account  = 'admin' AND  date  >= '1970-01-01' AND  date  <= '2109-01-01' AND  status IN ('wait','doing') ORDER BY `date`,`status`,`begin`  LIMIT 20 
...
20161212 17:47:06: block-printBlock-6-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '6'
  SELECT t1.*, t2.id as projectID, t2.name as projectName, t3.id as storyID, t3.title as storyTitle, t3.status AS storyStatus, t3.version AS latestStoryVersion FROM `zt_task` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_story` AS t3  ON t1.story = t3.id  WHERE t1.deleted  = '0' AND  t1.assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 
...
20161212 17:47:06: block-printBlock-7-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '7'
  SELECT * FROM `zt_bug` WHERE deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc  LIMIT 15 

20161212 17:47:06: block-printBlock-8-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '8'
  SELECT t1.*, t2.name as productTitle FROM `zt_story` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.deleted  = '0' AND  assignedTo  = 'admin' ORDER BY `id` desc 
...
20161212 17:47:06: block-printBlock-9-my
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_block` WHERE id  = '9'
  SELECT t1.assignedTo AS assignedTo, t2.* FROM `zt_testrun` AS t1  LEFT JOIN `zt_case` AS t2  ON t1.case = t2.id  LEFT JOIN `zt_testtask` AS t3  ON t1.task = t3.id  WHERE t1.assignedTo  = 'admin' AND  t1.status  != 'done' AND  t3.status  != 'done' AND  t3.deleted  = '0' AND  t2.deleted  = '0' ORDER BY `id` desc  LIMIT 15 

20161212 17:47:20: product
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 

20161212 17:47:20: product-browse
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *,  IF(INSTR(" closed", status) < 2, 0, 1) AS isClosed FROM `zt_product` WHERE deleted  = '0' ORDER BY `isClosed`,`order` desc 
  SELECT * FROM `zt_product` WHERE `id` = '3' 
...
20161212 17:47:21: user-login-Lw==
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
...
20161212 17:47:22: project
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 

20161212 17:47:23: project-task
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:47:37: task-create-3--0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 17:47:44: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 17:47:58: story-ajaxGetProjectStories-3-0-0-2
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 17:48:02: story-ajaxGetProjectStories-3-0-0-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t2.id, t2.title, t2.module, t2.pri, t2.estimate, t3.name AS product FROM `zt_projectstory` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_product` AS t3  ON t1.product = t3.id  WHERE t1.project  = '3' AND  t2.deleted  = '0'

20161212 17:48:12: story-ajaxGetModule-2
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 17:49:11: task-create-3--0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('评审：新闻中心1') AND  openedDate  >= '2016-12-12 17:48:11' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '2',`type` = 'review',`story` = '2',`color` = '',`name` = '评审：新闻中心1',`pri` = '3',`estimate` = '8',`desc` = '',`estStarted` = '0000-00-00',`deadline` = '0000-00-00',`mailto` = '',`project` = '3',`left` = '8',`status` = 'wait',`storyVersion` = '2',`openedBy` = 'admin',`openedDate` = '2016-12-12 17:49:11',`assignedTo` = 'dev2',`assignedDate` = '2016-12-12 17:49:11'
  ...
  SELECT * FROM `zt_file` WHERE id  = ''
  SELECT project, story FROM `zt_task` WHERE id  = '198'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '198',`actor` = 'admin',`action` = 'opened',`date` = '2016-12-12 17:49:11',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '784' 
  SELECT * FROM `zt_history` WHERE action IN ('784') ORDER BY `id` 

20161212 17:49:14: task-create-3-2-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 17:49:18: story-ajaxGetProjectStories-3-0-0-2
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT id,type,parent FROM `zt_module` WHERE id  = '2'
  SELECT * FROM `zt_module` WHERE `id` = '2' 
...
20161212 17:50:06: task-create-3-2-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT version FROM `zt_story` WHERE id  = '2'
  SELECT id,name FROM `zt_task` WHERE deleted  = '0' AND  name IN ('评审：新闻中心2') AND  openedDate  >= '2016-12-12 17:49:06' AND  project=3 
  INSERT INTO `zt_task` SET `module` = '2',`type` = 'review',`story` = '2',`color` = '',`name` = '评审：新闻中心2',`pri` = '3',`estimate` = '56',`desc` = '',`estStarted` = '2016-12-12',`deadline` = '2016-12-12',`mailto` = '',`project` = '3',`left` = '56',`status` = 'wait',`storyVersion` = '2',`openedBy` = 'admin',`openedDate` = '2016-12-12 17:50:06',`assignedTo` = 'dev1',`assignedDate` = '2016-12-12 17:50:06'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  UPDATE `zt_story` SET  `stage` = 'developed' WHERE id  = '2'
  SELECT * FROM `zt_file` WHERE id  = ''
  SELECT project, story FROM `zt_task` WHERE id  = '199'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '199',`actor` = 'admin',`action` = 'opened',`date` = '2016-12-12 17:50:06',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '785' 
  SELECT * FROM `zt_history` WHERE action IN ('785') ORDER BY `id` 

20161212 17:50:09: task-create-3-2-0
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 17:50:12: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:50:20: task-start-199
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
...
20161212 17:50:30: task-start-199
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `consumed` = '0',`left` = '56',`account` = 'admin',`task` = '199',`date` = '2016-12-12'
  UPDATE `zt_task` SET `realStarted` = '2016-12-12',`consumed` = '0',`left` = '56',`assignedTo` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 17:50:30',`assignedDate` = '2016-12-12 17:50:30',`status` = 'doing' WHERE id  = '199'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '199'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '199',`actor` = 'admin',`action` = 'started',`date` = '2016-12-12 17:50:30',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'realStarted',`old` = '0000-00-00',`new` = '2016-12-12',`diff` = '',`action` = '786'
  INSERT INTO `zt_history` SET `field` = 'assignedTo',`old` = 'dev1',`new` = 'admin',`diff` = '',`action` = '786'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'wait',`new` = 'doing',`diff` = '',`action` = '786'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '786' 
  SELECT * FROM `zt_history` WHERE action IN ('786') ORDER BY `id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'

20161212 17:50:32: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:50:35: task-start-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT t1.account, t2.realname FROM `zt_team` AS t1  LEFT JOIN `zt_user` AS t2  ON t1.account = t2.account  WHERE t1.project  = '3' AND  t2.deleted  = '0'
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '198' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('784') ORDER BY `id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
...
20161212 17:50:37: task-start-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `consumed` = '0',`left` = '8',`account` = 'admin',`task` = '198',`date` = '2016-12-12'
  UPDATE `zt_task` SET `realStarted` = '2016-12-12',`consumed` = '0',`left` = '8',`assignedTo` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 17:50:37',`assignedDate` = '2016-12-12 17:50:37',`status` = 'doing' WHERE id  = '198'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '198'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '198',`actor` = 'admin',`action` = 'started',`date` = '2016-12-12 17:50:37',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'realStarted',`old` = '0000-00-00',`new` = '2016-12-12',`diff` = '',`action` = '787'
  INSERT INTO `zt_history` SET `field` = 'assignedTo',`old` = 'dev2',`new` = 'admin',`diff` = '',`action` = '787'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'wait',`new` = 'doing',`diff` = '',`action` = '787'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '787' 
  SELECT * FROM `zt_history` WHERE action IN ('787') ORDER BY `id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'

20161212 17:50:38: project-task-3
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:51:26: search-buildForm
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT id, title FROM `zt_userquery` WHERE account  = 'admin' AND  module  = 'task' ORDER BY `id` asc 

20161212 17:51:50: search-buildQuery
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:51:51: project-task-3-bySearch-myQueryID
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT t1.product, t2.name FROM `zt_projectproduct` AS t1  LEFT JOIN `zt_product` AS t2  ON t1.product = t2.id  WHERE t1.project  = '3'
  SELECT id FROM `zt_task` WHERE (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  AND  deleted  = '0' ORDER BY `status`,`id` desc 
  SELECT COUNT(*) AS recTotal FROM `zt_task` WHERE (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  AND  deleted  = '0' 
  SELECT id FROM `zt_task` WHERE (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  AND  deleted  = '0' ORDER BY `status`,`id` desc 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.product, t2.branch, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.deleted  = '0' AND  t1.id IN ('135','134','132','131','130','129','128','127','126','125','199','198','164','197','196','194','190','187','185','182','181','180','133') ORDER BY `status`,`id` desc 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
...
20161212 17:51:52: search-buildForm
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT id, title FROM `zt_userquery` WHERE account  = 'admin' AND  module  = 'task' ORDER BY `id` asc 

20161212 17:52:11: search-buildQuery
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 17:52:12: project-task-3-bySearch-myQueryID
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
...
20161212 17:52:13: search-buildForm
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT id, title FROM `zt_userquery` WHERE account  = 'admin' AND  module  = 'task' ORDER BY `id` asc 

20161212 17:52:23: task-finish-199
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '199' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('785','786') ORDER BY `id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
            SUM(estimate) AS totalEstimate, 
...
20161212 17:53:36: task-finish-199
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
...
20161212 17:53:49: task-finish-199
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `account` = 'admin',`task` = '199',`date` = '2016-12-12',`left` = '0',`consumed` = '8'
  UPDATE `zt_task` SET `consumed` = '8',`assignedTo` = 'admin',`finishedDate` = '2016-12-12 17:53:48',`left` = '0',`assignedDate` = '2016-12-12 17:53:48',`status` = 'done',`finishedBy` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 17:53:48' WHERE id  = '199'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '199'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '199',`actor` = 'admin',`action` = 'finished',`date` = '2016-12-12 17:53:48',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'consumed',`old` = '0',`new` = '8',`diff` = '',`action` = '788'
  INSERT INTO `zt_history` SET `field` = 'finishedDate',`old` = '',`new` = '2016-12-12 17:53:48',`diff` = '',`action` = '788'
  INSERT INTO `zt_history` SET `field` = 'left',`old` = '56',`new` = '0',`diff` = '',`action` = '788'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'doing',`new` = 'done',`diff` = '',`action` = '788'
  INSERT INTO `zt_history` SET `field` = 'finishedBy',`old` = '',`new` = 'admin',`diff` = '',`action` = '788'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '199'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '199' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '788' 
  SELECT * FROM `zt_history` WHERE action IN ('788') ORDER BY `id` 

20161212 17:53:49: project-task-3-bySearch-myQueryID
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT COUNT(*) AS recTotal FROM `zt_task` WHERE (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  AND  deleted  = '0' 
  SELECT id FROM `zt_task` WHERE (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  AND  deleted  = '0' ORDER BY `status`,`id` desc 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.product, t2.branch, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.deleted  = '0' AND  t1.id IN ('135','134','132','131','130','129','128','127','126','125','198','164','199','197','196','194','190','187','185','182','181','180','133') ORDER BY `status`,`id` desc 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
...
20161212 17:53:51: task-view-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_review` WHERE task  = '198'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = ''
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT title,spec,verify FROM `zt_storyspec` WHERE story  = '2' AND  version  = '2'
  SELECT t1.project, t2.name, t2.status FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  WHERE t1.story  = '2' ORDER BY t1.`project` DESC 
  ...
  UPDATE `zt_action` SET  `read` = '1' WHERE objectType  = 'task' AND  objectID  = '198' AND  `read`  = '0'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  SELECT 
            SUM(estimate) AS totalEstimate, 
            SUM(consumed) AS totalConsumed, 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '198' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('784','787') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_task` WHERE id  = '198' OR (( 1   AND `type` = 'review'  ) AND ( 1  AND `pri` = '3'  )) AND deleted = '0' AND `project` = 3  ORDER BY `status`,`id` desc 
...
20161212 17:53:55: task-finish-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
...
20161212 17:54:24: task-finish-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
...
20161212 17:54:31: task-finish-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  INSERT INTO `zt_taskestimate` SET `account` = 'admin',`task` = '198',`date` = '2016-12-12',`left` = '0',`consumed` = '56'
  UPDATE `zt_task` SET `consumed` = '56',`assignedTo` = 'admin',`finishedDate` = '2016-12-12 17:54:31',`left` = '0',`assignedDate` = '2016-12-12 17:54:31',`status` = 'done',`finishedBy` = 'admin',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 17:54:31' WHERE id  = '198'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '198'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '198',`actor` = 'admin',`action` = 'finished',`date` = '2016-12-12 17:54:31',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'consumed',`old` = '0',`new` = '56',`diff` = '',`action` = '789'
  INSERT INTO `zt_history` SET `field` = 'finishedDate',`old` = '',`new` = '2016-12-12 17:54:31',`diff` = '',`action` = '789'
  INSERT INTO `zt_history` SET `field` = 'left',`old` = '8',`new` = '0',`diff` = '',`action` = '789'
  INSERT INTO `zt_history` SET `field` = 'status',`old` = 'doing',`new` = 'done',`diff` = '',`action` = '789'
  INSERT INTO `zt_history` SET `field` = 'finishedBy',`old` = '',`new` = 'admin',`diff` = '',`action` = '789'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '789' 
  SELECT * FROM `zt_history` WHERE action IN ('789') ORDER BY `id` 

20161212 17:54:32: task-view-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '198' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('784','787','789') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT path FROM `zt_module` WHERE id  = '2'
  SELECT * FROM `zt_module` WHERE id  = '2'
  SELECT name FROM `zt_product` WHERE id  = '1'
...
20161212 17:54:36: task-edit-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
...
20161212 18:00:55: task-edit-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT version FROM `zt_story` WHERE id  = '2'
  SELECT * FROM `zt_review` WHERE task  = '198'
  UPDATE `zt_task` SET `module` = '2',`type` = 'review',`story` = '2',`color` = '',`name` = '评审：新闻中心1',`pri` = '3',`estimate` = '8',`desc` = '',`estStarted` = '0000-00-00',`deadline` = '0000-00-00',`mailto` = '',`project` = '3',`left` = '0',`status` = 'done',`assignedTo` = 'admin',`assignedDate` = '',`consumed` = '56',`realStarted` = '2016-12-12',`finishedBy` = 'admin',`finishedDate` = '2016-12-12 17:54:31',`canceledBy` = '',`canceledDate` = '',`closedBy` = '',`closedReason` = '',`closedDate` = '',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 18:00:54' WHERE id  = '198'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
...
20161212 18:02:49: task-edit-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT * FROM `zt_release` WHERE CONCAT(',', stories, ',')  LIKE '%,2,%' AND  deleted  = '0'
  UPDATE `zt_story` SET  `stage` = 'developed' WHERE id  = '2'
  INSERT INTO `zt_review` SET `fileNO` = 'SRS',`recorder` = 'lll',`reviewName` = '需求评审',`task` = '198',`doc` = '',`referenceDoc` = '呃剋',`reference` = 'V1.0',`pages` = '34',`reviewers` = '呵呵，西鞥乡，恶搞edging，诶嗯的',`reviewDate` = '2016-12-12',`reviewScope` = '1-20页',`reviewPlace` = '6号会议室',`effort` = '30',`conclusion` = '通过'
  INSERT INTO `zt_reviewDetail` SET `reviewID` = '33',`number` = '1',`reviewer` = '额额',`item` = '3',`line` = '30',`severity` = 'A',`description` = '测试',`proposal` = '改',`changed` = 'Y',`action` = '',`chkd` = 'Y'
  INSERT INTO `zt_reviewDetail` SET `reviewID` = '33',`number` = '2',`reviewer` = '得额高',`item` = '4',`line` = '20',`severity` = 'B',`description` = '曾额我',`proposal` = 'engine',`changed` = 'C',`action` = '',`chkd` = 'N'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
  ...
  SELECT project, story FROM `zt_task` WHERE id  = '198'
  SELECT product FROM `zt_story` WHERE id  = '2'
  INSERT INTO `zt_action` SET `objectType` = 'task',`objectID` = '198',`actor` = 'admin',`action` = 'edited',`date` = '2016-12-12 18:02:49',`comment` = '',`extra` = '',`product` = ',1,',`project` = '3'
  INSERT INTO `zt_history` SET `field` = 'fileNO',`old` = '',`new` = 'SRS',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'recorder',`old` = '',`new` = 'lll',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewName',`old` = '',`new` = '需求评审',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'referenceDoc',`old` = '',`new` = '呃剋',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reference',`old` = '',`new` = 'V1.0',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'pages',`old` = '',`new` = '34',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewers',`old` = '',`new` = '呵呵，西鞥乡，恶搞edging，诶嗯的',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewDate',`old` = '',`new` = '2016-12-12',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewScope',`old` = '',`new` = '1-20页',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewPlace',`old` = '',`new` = '6号会议室',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'effort',`old` = '',`new` = '30',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'conclusion',`old` = '',`new` = '通过',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '',`new` = '1',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = '',`new` = '额额',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = '',`new` = '3',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = '',`new` = '30',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'severity',`old` = '',`new` = 'A',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = '',`new` = '测试',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = '',`new` = '改',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'changed',`old` = '',`new` = 'Y',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'chkd',`old` = '',`new` = 'Y',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'number',`old` = '',`new` = '2',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'reviewer',`old` = '',`new` = '得额高',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'item',`old` = '',`new` = '4',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'line',`old` = '',`new` = '20',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'severity',`old` = '',`new` = 'B',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'description',`old` = '',`new` = '曾额我',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'proposal',`old` = '',`new` = 'engine',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'changed',`old` = '',`new` = 'C',`diff` = '',`action` = '790'
  INSERT INTO `zt_history` SET `field` = 'chkd',`old` = '',`new` = 'N',`diff` = '',`action` = '790'
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_project` WHERE `id` = '3' 
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT * FROM `zt_action` WHERE `id` = '790' 
  SELECT * FROM `zt_history` WHERE action IN ('790') ORDER BY `id` 

20161212 18:02:50: task-view-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  SELECT id, title FROM `zt_case` WHERE story  = '2' AND  storyVersion  = '2'
  SELECT * FROM `zt_review` WHERE task  = '198'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = '33'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT title,spec,verify FROM `zt_storyspec` WHERE story  = '2' AND  version  = '2'
  SELECT t1.project, t2.name, t2.status FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  WHERE t1.story  = '2' ORDER BY t1.`project` DESC 
  SELECT id, name, assignedTo, project, status, consumed, `left` FROM `zt_task` WHERE story  = '2' AND  deleted  = '0' ORDER BY `id` DESC 
  ...
  SELECT commiter, account, realname FROM `zt_user` WHERE commiter  != ''
  SELECT * FROM `zt_action` WHERE objectType  = 'task' AND  objectID  = '198' ORDER BY `date`,`id` 
  SELECT * FROM `zt_history` WHERE action IN ('784','787','789','790') ORDER BY `id` 
  SELECT account, realname, deleted FROM `zt_user` ORDER BY `account` 
  SELECT path FROM `zt_module` WHERE id  = '2'
  SELECT * FROM `zt_module` WHERE id  = '2'
  SELECT name FROM `zt_product` WHERE id  = '1'
...
20161212 18:04:39: task-edit-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT sum(days * hours) AS totalHours FROM `zt_team` WHERE project  = '3'
  SELECT * FROM `zt_review` WHERE task  = '198'
  SELECT * FROM `zt_reviewDetail` WHERE reviewID  = '33' AND  deleted  = '0'
  SELECT *, IF(INSTR(" done", status) < 2, 0, 1) AS isDone FROM `zt_project` WHERE iscat  = '0' AND  deleted  = '0' ORDER BY `isDone`,`status`,`order` desc 
  SELECT t2.id, t2.title, t2.module, t2.pri, t2.estimate, t3.name AS product FROM `zt_projectstory` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_product` AS t3  ON t1.product = t3.id  WHERE t1.project  = '3' AND  t2.deleted  = '0'
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT account, realname, deleted FROM `zt_user` WHERE account IN ('admin','','')
...
20161212 18:14:40: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 18:24:42: misc-ping
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 18:28:49: task-edit-198
  SELECT * FROM `zt_config` WHERE owner IN ('system','admin') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT t1.*, t2.id AS storyID, t2.title AS storyTitle, t2.version AS latestStoryVersion, t2.status AS storyStatus, t3.realname AS assignedToRealName FROM `zt_task` AS t1  LEFT JOIN `zt_story` AS t2  ON t1.story = t2.id  LEFT JOIN `zt_user` AS t3  ON t1.assignedTo = t3.account  WHERE t1.id  = '198'
  SELECT * FROM `zt_file` WHERE objectType  = 'task' AND  objectID  = '198' AND  extra  != 'editor'
  ...
  SELECT version FROM `zt_story` WHERE id  = '2'
  SELECT * FROM `zt_review` WHERE task  = '198'
  SELECT * FROM `zt_review` WHERE id  = '33'
  UPDATE `zt_task` SET `module` = '2',`type` = 'review',`story` = '2',`color` = '',`name` = '评审：新闻中心1',`pri` = '3',`estimate` = '8',`desc` = '',`estStarted` = '0000-00-00',`deadline` = '0000-00-00',`mailto` = '',`project` = '3',`left` = '0',`status` = 'done',`assignedTo` = 'admin',`assignedDate` = '',`consumed` = '56',`realStarted` = '2016-12-12',`finishedBy` = 'admin',`finishedDate` = '2016-12-12 17:54:31',`canceledBy` = '',`canceledDate` = '',`closedBy` = '',`closedReason` = '',`closedDate` = '',`lastEditedBy` = 'admin',`lastEditedDate` = '2016-12-12 18:28:49' WHERE id  = '198'
  DELETE FROM `zt_storystage` WHERE story  = '2'
  SELECT * FROM `zt_story` WHERE `id` = '2' 
  SELECT * FROM `zt_product` WHERE `id` = '1' 
  SELECT t1.project,t3.branch FROM `zt_projectstory` AS t1  LEFT JOIN `zt_project` AS t2  ON t1.project = t2.id  LEFT JOIN `zt_projectproduct` AS t3  ON t1.project = t3.project  WHERE t1.story  = '2' AND  t2.deleted  = '0'
...
20161212 22:48:02: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 22:48:02: cron-ajaxExec
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
...
20161212 23:00:08: user-login-Lw==
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
  SELECT account, realname, deleted FROM `zt_user` WHERE deleted  = '0' ORDER BY `account` 
  SELECT * FROM `zt_cron` ORDER BY `lastTime` desc  LIMIT 1 

20161212 23:00:08: cron-ajaxExec
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 23:01:07: phpmyadmin
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 

20161212 23:21:44: zentao/upgrade
  SELECT * FROM `zt_company` ORDER BY `id`  LIMIT 1 
  SELECT * FROM `zt_config` WHERE owner IN ('system','') ORDER BY `id` 
  SELECT * FROM `zt_lang` ORDER BY `lang`,`id` 
=======
