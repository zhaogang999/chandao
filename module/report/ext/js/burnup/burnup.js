    ...
    jQuery.fn.tableChart = function()
    {
        $(this).each(function()
        {
            ...
            for (var i=1;i<=cols;i++){
                ...
                $series.push({name:$groupLabel,type:'line',data:colData,itemStyle:{normal:{label:{show:true,position: 'top'}}}});
            }

            var dom = document.getElementById("burnUp");
