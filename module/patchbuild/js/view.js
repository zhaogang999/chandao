function showLink(buildID, type, from, param)
{
    var method = type == 'story' ? 'linkStory' : 'linkBug';
    $.get(createLink('patchbuild', method, 'buildID=' + buildID + '&from=' + from + (typeof(param) == 'undefined' ? '' : param)), function(data)
    {
...
$(function()
{
    if(link == 'true') showLink(buildID, type, from, param);
