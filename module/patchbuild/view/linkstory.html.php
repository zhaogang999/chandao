...
<div id='unlinkStoryList'>
  <form method='post' id='unlinkedStoriesForm' target='hiddenwin' action='<?php echo $this->createLink('patchbuild', 'linkStory', "buildID={$build->id}&from=$from&browseType=$browseType&param=$param");?>'>
    ...
    <caption class='text-left text-special'><?php echo html::icon('unlink');?> &nbsp;<strong><?php echo $lang->productplan->unlinkedStories;?></strong></caption>
      ...
      <?php if(strpos(",{$build->linkStories},", ",{$story->id},") !== false) continue; ?>
