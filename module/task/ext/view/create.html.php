        ...
        <td colspan='5'>
          <table class='table table-form table-fixed with-border'>
            ...
            <tr class='text-center'>
              <th class='w-20px'><?php echo $lang->task->auditID; ?><span class="required required-wrapper"></span></th>
              <th class='w-100px'><?php echo $lang->task->noDec; ?><span class="required required-wrapper"></span></th>
              <th class='w-40px'><?php echo $lang->task->noType; ?><span class="required required-wrapper"></span></th>
              <th class='w-40px'><?php echo $lang->task->serious; ?><span class="required required-wrapper"></span></th>
              <th class='w-100px'><?php echo $lang->task->cause; ?><span class="required required-wrapper"></span></th>
              <th class='w-100px'><?php echo $lang->task->measures; ?><span class="required required-wrapper"></span></th>
