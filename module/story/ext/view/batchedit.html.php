  ...
  <table class='table table-form table-fixed with-border'>
    ...
    <tbody>
      ...
      <tr class='text-center'>
        ...
        <!--需求可以批量指派给多人-->
        <td class='text-left<?php echo zget($visibleFields, 'assignedTo', ' hidden')?>' style='overflow:visible'><?php echo html::select("assignedTo[$storyID][]",     $users, $stories[$storyID]->assignedTo, "class='form-control chosen' multiple");?></td>
