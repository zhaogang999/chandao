        ...
        <td colspan='2'>
          <div class='row-table'>
            ...
            <div class='col-table <?php echo $widthClass?>'>
              <div class='input-group'>
                <?php if($showSeverity):?>
                <div class="input-group-addon fix-border br-0 minw-80px"><?php echo $lang->bug->severity;?><span class="required required-wrapper" style="top:-4px;"></span></div>
                ...
                <?php echo html::select('severity', (array)$lang->bug->severityList, '', "class='form-control minw-80px'");?>
                <?php else: ?>
                <div class='input-group-btn dropdown-pris' data-prefix='severity'>
                  ...
                  <?php echo html::select('severity', (array)$lang->bug->severityList, '', "class='hide'");?>
                </div>
                <?php endif; ?>
                <?php endif;?>
                <?php if($showPri):?>
